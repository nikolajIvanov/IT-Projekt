...
profil = api.inherit('Profil', bo, {
    ...
    'lerntyp': fields.String(attribute=lambda x: x.get_lerntyp(), description='Lerntyp eines Benutzers'),    'modul': fields.List(fields.String(attribute=lambda x: x.get_modul(), description='Module eines Benutzers')),
